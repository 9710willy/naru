...
Implementation of _Context as an Environment_ ([arXiv
2608.21690](https://arxiv.org/abs/2608.21690)). The agent's history lives in a
SQLite Event Log and a persistent Python kernel; the model writes code to reach
it and only what it prints enters the next call.
